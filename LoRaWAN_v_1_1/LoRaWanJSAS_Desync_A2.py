...
if lemma[0:7]=="correct":
  ...
  for line in lines:
    ...
    elif re.match('.*ASCommissioned\(*', line): rank[108].append(num)
    elif re.match('.*ED_State.*', line): rank[108].append(num)
    elif re.match('.*In_S.*', line): rank[105].append(num)
    elif re.match('.*KU\( ~JSASKey.*', line): rank[100].append(num)
    elif re.match('.*KU\( AesKey\(.*JSAS.*JSAS.*', line): rank[100].append(num)    
    elif re.match('.*KU\( AesKey\(.*Nwk.*~rootNwkKey.*', line): rank[90].append(num)
    elif re.match('.*KU\( ~rootNwkKey.*', line): rank[90].append(num)
...
# elif lemma[0:5]=="able_":
  ...
  # for line in lines:
    ...
    # elif re.match('.*ASCommissioned\(*', line): rank[108].append(num)
    # elif re.match('.*ED_State.*', line): rank[108].append(num)
    # elif re.match('.*KU\( senc\(<\'0x0.*Key\)\)', line): rank[105].append(num)
    # elif re.match('.*KU\( ~JSASKey.*', line): rank[105].append(num)
    ...
    # elif re.match('.*KU\( senc\(.*MAC.*SessionKey.*SessionKey.*~rootNwk.*', line): rank[85].append(num)
    # elif re.match('.*KU\( MAC.*SessionKey.*~rootNwkKey\)\)\)\).*', line): rank[85].append(num)
    # elif re.match('.*KU\( SessionKey.*~rootNwkKey\)\)\)\).*', line): rank[85].append(num)
    # elif re.match('.*KU\( senc\(<\'0x0.*~rootNwkKey\)\)\)', line): rank[85].append(num)
